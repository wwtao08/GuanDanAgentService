...
export class TeamAI {
    ...
    async selectCards(cards, lastPattern, position) {
    ...
    buildHintInput(cards, lastPattern, position) {
    ...
    buildMessagePrompt(selectedCards, handCards, lastPattern, position, teammatePosition) {
    ...
    generateSimpleMessage(selectedCards, lastPattern) {
        if (selectedCards.length === 0)
            return undefined;
